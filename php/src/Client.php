...
namespace APIVerve\Htmlentities;
...
/**
 * Client for the HTML Entities Encoder/Decoder API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/htmlentities?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/htmlentities';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HtmlentitiesClient] {$message}\n";
        }
    }
}
