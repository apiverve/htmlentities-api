...
// Request contains the parameters for the HTML Entities Encoder/Decoder API.
//
// Parameters:
...
// ResponseData contains the data returned by the HTML Entities Encoder/Decoder API.
type ResponseData struct {
	Action string `json:"action"`
	Original string `json:"original"`
	Encoded string `json:"encoded"`
	EntitiesReplaced []string `json:"entities_replaced"`
