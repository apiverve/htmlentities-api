...
namespace APIVerve.API.HTMLEntitiesEncoderDecoder
{
    ...
    /// <summary>
    /// Client for the HTMLEntitiesEncoderDecoder API
    /// </summary>
    public class HTMLEntitiesEncoderDecoderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/htmlentities";
        ...
        public HTMLEntitiesEncoderDecoderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HTMLEntitiesEncoderDecoderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HTMLEntitiesEncoderDecoderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, HTMLEntitiesEncoderDecoderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(HTMLEntitiesEncoderDecoderQueryOptions options)
        {
        ...
        public ResponseObj Execute(HTMLEntitiesEncoderDecoderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(HTMLEntitiesEncoderDecoderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(HTMLEntitiesEncoderDecoderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(HTMLEntitiesEncoderDecoderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(HTMLEntitiesEncoderDecoderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(HTMLEntitiesEncoderDecoderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(HTMLEntitiesEncoderDecoderQueryOptions options)
        {
