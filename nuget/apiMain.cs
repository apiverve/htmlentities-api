...
{
    /// <summary>
    /// Client for the APIVerve.API.HTMLEntitiesEncoder/Decoder API
    /// </summary>
...
#endif
    {
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HTMLEntitiesEncoder/DecoderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HTMLEntitiesEncoder/DecoderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, HTMLEntitiesEncoder/DecoderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        public ResponseObj Execute(HTMLEntitiesEncoder/DecoderQueryOptions options = null)
        {
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        public Task<ResponseObj> ExecuteAsync(HTMLEntitiesEncoder/DecoderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(HTMLEntitiesEncoder/DecoderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(HTMLEntitiesEncoder/DecoderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(HTMLEntitiesEncoder/DecoderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(HTMLEntitiesEncoder/DecoderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(HTMLEntitiesEncoder/DecoderQueryOptions options)
        {
