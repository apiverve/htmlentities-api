# HTML Entities Encoder/Decoder Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:htmlentities-api:1.1.12'
}
```
...
```java
import com.apiverve.htmlentities.HTMLEntitiesEncoder/DecoderAPIClient;
import com.apiverve.htmlentities.APIResponse;
import com.apiverve.htmlentities.APIException;

// Initialize the client
HTMLEntitiesEncoder/DecoderAPIClient client = new HTMLEntitiesEncoder/DecoderAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/htmlentities](https://docs.apiverve.com/ref/htmlentities)
...
- **Documentation:** [https://docs.apiverve.com/ref/htmlentities](https://docs.apiverve.com/ref/htmlentities)
- **Issues:** [GitHub Issues](https://github.com/apiverve/htmlentities-api/issues)
