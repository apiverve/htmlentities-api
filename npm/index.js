...
class htmlentitiesWrapper {
    ...
    constructor(options) {
        ...
        this.validationRules = {"html":{"type":"string","required":true},"action":{"type":"string","required":false,"default":"encode"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/htmlentities`);
        }
    }
